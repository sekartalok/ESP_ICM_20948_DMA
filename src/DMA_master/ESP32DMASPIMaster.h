...
ESP32DMASPIMaster.h - original code by(https://github.com/hideakitai/ESP32DMASPI/tree/main)
MIT LICENSE : Copyright (c) 2019 Hideaki Tai
MODIFIED by sekartalok
NOTE:
adding static to IRAM_ATTR  
